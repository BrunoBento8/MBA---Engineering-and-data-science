USE MASTER -- Colocando na base antes para não ter problema de usuário conectado, caso o DISCIPLINA02 existisse
GO
...
ADD TOTAL AS VALOR * QUANTIDADE; -- Criação da coluna calculada
GO
